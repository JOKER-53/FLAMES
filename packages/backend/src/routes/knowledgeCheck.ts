// ============================================================================
// GET /api/knowledge-check/:taskId
// Returns a freshly AI-generated MCQ for the given task. Each call produces
// a new question so students can't share answers or guess from patterns.
// ============================================================================
...
// Maps every task id to a human title + the core concept NIM should test.
...
knowledgeCheckRouter.get("/:taskId", async (req, res) => {
